...
! function(t, i) {
  ...
  function n(t) {
    for (; t._start = t._waiting && t._active < t._size;) {
      var i = t._ended + t._active,
        ...
        n = r.length - 1,
        e = r[n];
      r[n] = a(t, i), --t._waiting, ++t._active, r = e.apply(null, r), t._tasks[i] && (t._tasks[i] = r || c)
    }
  }

  function a(t, i) {
    return function(n, a) {
      t._tasks[i] && (--t._active, ++t._ended, t._tasks[i] = null, null == t._error && (null != n ? e(t, n) : (t._data[i] = a, t._waiting ? r(t) : o(t))))
    }
  }
  ...
  function e(t, i) {
    ...
    for (t._error = i, t._data = void 0, t._waiting = NaN; --n >= 0;)
      if ((r = t._tasks[n]) && (t._tasks[n] = null, r.abort)) try {
        r.abort()
      } catch (i) {}
    t._active = NaN, o(t)
  }
  ...
  }, t.queue = s, Object.defineProperty(t, "__esModule", {
    value: !0
  })
});
